  ...
  return (
    <div className="page">
      <div className="hero">
        ...
        <p>Keep your catalog updated, inventory visible, and product details organized all from one dashboard.</p>
            ...
            {featuredProducts.map((product) => (
              <div className="product-card" key={product.id}>
                ...
                <div className="product-info">
                  ...
                  <Link to={`/products/${product.id}`} className="btn-edit" style={{ textAlign: "center", textDecoration: "none" }}>
                    View Details
                  </Link>
                </div>
              </div>
